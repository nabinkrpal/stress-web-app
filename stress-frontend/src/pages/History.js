...
//                       {item.image_path && (
//                         <img
//                           src={`http://192.168.1.19:8000/${item.image_path}`}
//                           alt="Captured"
...
//                         <p>😴 Sleep: {item.sleep_hours} hrs</p>
//                         <p>📚 Study: {item.study_hours} hrs</p>
//                         <p>📱 Screen: {item.screen_time} hrs</p>
                ...
                >
                  ...
                  {item.type === "webcam" ? (
                    <div>
                      ...
                      {item.image && (
                        <img
                          src={`http://192.168.1.19:8000/${item.image}`}
                          alt="Captured"
